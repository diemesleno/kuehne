# Generated by Django 2.0.7 on 2018-07-26 17:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'In Transit'), ('2', 'Delivered')], max_length=1)),
                ('last_location', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='city_last_located', to='core.City', verbose_name='Last Location')),
